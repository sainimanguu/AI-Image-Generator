            ...
            <form onSubmit={onSubmitHandler} className='relative bg-white p-10 rounded-xl text-slate-500 w-96'>
                ...
                {state === 'Login' ? (
                    <p className='mt-5 text-center text-sm'>
                        ...
                        <span className='text-blue-600 cursor-pointer font-medium' onClick={() => setState('Sign Up')}>
                            Sign Up
                        </span>
                    </p>
                ) : (
                    <p className='mt-5 text-center text-sm'>
                        ...
                        <span className='text-blue-600 cursor-pointer font-medium' onClick={() => setState('Login')}>
                            Log In
                        </span>
                    </p>
                )}
